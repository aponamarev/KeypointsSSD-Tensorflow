...
tf.app.flags.DEFINE_integer('gpu_memory_fraction', 0.8, 'GPU memory fraction to use.')
...
tf.app.flags.DEFINE_integer('num_classes', 1, 'Number of classes to use in the dataset.')
...
def main(_):
    ...
    with tf.Graph().as_default():
        ...
        with tf.device(deploy_config.inputs_device()):
            ...
            [image, shape, glabels, gbboxes, keypoints] = provider.get(
                ['image', 'shape', 'object/label', 'object/bbox', 'object/keypoints'])
